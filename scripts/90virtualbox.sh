...
# cd /tmp
# [[ -f VBoxGuestAdditions_5.0.14.iso ]] || curl "http://download.virtualbox.org/virtualbox/5.0.20/VBoxGuestAdditions_5.0.20.iso" -O
# mount -o loop VBoxGuestAdditions_5.0.20.iso /mnt
